 ...
 *
 * Open terminal #2
 * $ rosrun dynamixel_sdk_robot bulk_read_write_node
 *
 * Open terminal #3 (run one of below commands at a time)
 * $ rostopic pub -1 /bulk_set_item dynamixel_sdk_robot/BulkSetItem "{id1: 1, id2: 2, item1: 'position', item2: 'LED', value1: 1000, value2: 1}"
 * $ rostopic pub -1 /bulk_set_item dynamixel_sdk_robot/BulkSetItem "{id1: 1, id2: 2, item1: 'LED', item2: 'position', value1: 1, value2: 1000}"
...
#include "dynamixel_sdk_robot/BulkGetItem.h"
#include "dynamixel_sdk_robot/BulkSetItem.h"
...
bool bulkGetItemCallback(
  dynamixel_sdk_robot::BulkGetItem::Request & req,
  dynamixel_sdk_robot::BulkGetItem::Response & res)
{
  uint8_t dxl_error = 0;
...
void bulkSetItemCallback(const dynamixel_sdk_robot::BulkSetItem::ConstPtr & msg)
{
  uint8_t dxl_error = 0;
  int dxl_comm_result = COMM_TX_FAIL;
  int dxl_addparam_result = false;
