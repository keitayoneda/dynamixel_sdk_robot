 ...
 *
 * Open terminal #2
 * $ rosrun dynamixel_sdk_robot read_write_node
 *
 * Open terminal #3 (run one of below commands at a time)
 * $ rostopic pub -1 /set_position dynamixel_sdk_robot/SetPosition "{id: 1, position: 0}"
 * $ rostopic pub -1 /set_position dynamixel_sdk_robot/SetPosition "{id: 1, position: 1000}"
 * $ rosservice call /get_position "id: 1"
 * $ rostopic pub -1 /set_position dynamixel_sdk_robot/SetPosition "{id: 2, position: 0}"
 * $ rostopic pub -1 /set_position dynamixel_sdk_robot/SetPosition "{id: 2, position: 1000}"
...
#include "dynamixel_sdk_robot/GetPosition.h"
#include "dynamixel_sdk_robot/SetPosition.h"
...
bool getPresentPositionCallback(
  dynamixel_sdk_robot::GetPosition::Request & req,
  dynamixel_sdk_robot::GetPosition::Response & res)
{
  uint8_t dxl_error = 0;
...
void setPositionCallback(const dynamixel_sdk_robot::SetPosition::ConstPtr & msg)
{
  uint8_t dxl_error = 0;
  int dxl_comm_result = COMM_TX_FAIL;
